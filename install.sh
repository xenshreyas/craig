...
config_env() {
  ...
  env_names=(
    ...
    "AI_BILLING_OVERRIDE_USER_IDS"
    "AI_BUDGET_TRANSCRIPT_COST_PER_MINUTE_USD"
    "AI_BUDGET_SUMMARY_INPUT_COST_PER_1M_TOKENS_USD"
    "AI_BUDGET_SUMMARY_CACHED_INPUT_COST_PER_1M_TOKENS_USD"
    "AI_BUDGET_SUMMARY_OUTPUT_COST_PER_1M_TOKENS_USD"
    ...
    "TRANSCRIPT_CHUNK_ENABLED"
    "TRANSCRIPT_CHUNK_DURATION_SEC"
    "TRANSCRIPT_CHUNK_FORMAT"
    "TRANSCRIPT_CHUNK_BITRATE_KBPS"
    "TRANSCRIPT_CHUNK_SAMPLE_RATE"
    "STRIPE_SECRET_KEY"
